...
// Helper for qsort — sorts entries alphabetically by path
...
int index_save(const Index *index) {
    ...
    // MUST use heap — Index struct is ~5MB, too large for the stack.
...
int index_add(Index *index, const char *path) {
    ...
    // Step 2: Write as a blob to the object store
    ObjectID blob_id;
    ...
    // Step 4: Update or add the entry in the index
